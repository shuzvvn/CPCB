...
df_train = pd.read_csv("/home/shc167/ML_hw1/census.csv")
df_test = pd.read_csv("/home/shc167/ML_hw1/adult.test.csv")

# f_train = "census.csv"
# f_test = "adult.test.csv"

# with open(f_train) as csv_file:
# 	csv_reader = csv.reader(csv_file, delimiter=',')
# 	title_train = np.array(next(csv_reader))
# 	data_train = np.array([r for r in csv_reader])

# with open(f_test) as csv_file:
# 	csv_reader = csv.reader(csv_file, delimiter=',')
# 	title_test = np.array(next(csv_reader))
# 	data_test = np.array([r for r in csv_reader])
